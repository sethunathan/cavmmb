...
<div class="entryscreen" style="display:none;">
    ...
    <table class="table">
		...
		?>  </td>
		 <tr>
		    <td><label>Accounts From-Cash/Bank</label></td>
		...
		<tr>
		 ...
		 <tr>
		    <td><label>Accounts To - Cash/Bank </label></td>
				<td>
...
<div class="mainscreen"  >
    <div class="col-sm-2">	
	   <button type="button" id="entry"  class="btnDeleteAction" >Add New-Contra</button> 
	</div>	
...
<div class="modal fade" id="exampleModal"   role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
		...
		<input type="text" readonly   value ="Accounts From-Cash/Bank" class="form-control"> 
		<div class="form-group has-feedback">
        ...
        <input type="text" readonly   value ="Accounts To Cash/Bank" class="form-control"> 
		  <div class="form-group has-feedback">
...
//////////////////////////
  ...
  $('#exampleModal').on('show.bs.modal', function (e) {
	...
	$.ajax({
		url: '<?php echo site_url("accounts/getaccbillingcontra")?>',
		type: "POST",
		data:'vch_no='+vch_no, 
...
{ 
	...
	$.ajax({
		        url: '<?php echo site_url("accounts/savecontra")?>',
		        type:'POST',
				async: false,
...
function getsaveaccounts(action) {
	...
	url: '<?php echo site_url("accounts/editsavebillcontra")?>',

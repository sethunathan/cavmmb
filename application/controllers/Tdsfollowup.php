...
class Tdsfollowup extends CI_Controller {
	...
	{	
	   ...
	   $data['followupp'] = 0;
        ...
        $this->load->view('futurelisttdsalter',$data);	
	}
	...
	{	
	   ...
	   $data['followupp'] = 0;
	    ...
	    $this->db->order_by('movetotask,nextreminderat,trntask2.id,trntask1.task_code,ac_name,trntask2.ac_code');   
	    $this->db->select('movetotask,empname,nextreminderat,task_name,ac_name,trntask2.ac_code,
	    ...
	    $data['client'] = $this->db->get('trntask2')->result_array();
        $this->load->view('tdsfollowupalter',$data);	
	}
	...
	private function stripHTMLtags($str)
{
	...
	{	
		...
		$this->db->join('massubjob', 'trntask1.subjob_code = massubjob.subjob_code','left');
	    $data['client'] = $this->db->get('trntask2')->result_array();
        $this->load->view('tdsfollowuptask',$data);	
	}
	...
	{	
        ...
        $this->db->join('massubjob', 'trntask1.subjob_code = massubjob.subjob_code','left');		
	    $data['client'] = $this->db->get('trntask2')->result_array();
        $this->load->view('tdsverification',$data);	
	}

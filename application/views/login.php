...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <script src="<?php echo base_url(); ?>homeassests/js/jquery.min.js"></script>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>login/auth"><b>CAVMMB</b>&Co</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url(); ?>login/auth" method="post">
      <div class="form-group has-feedback">
        <input name="username" type="text" class="form-control" placeholder="Admin ID">

...
#btnAddAction{background-color:#09F;border:0;padding:5px 10px;color:#FFF;}
 ...
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>admin/form16tds">
            <i class="fa fa-dashboard"></i> <span>Form 16  T.D.S - Refresh</span>
...
<form action="<?php echo base_url(); ?>admin/form16tds" method="post">
...
<?php $i=1; foreach ($client as $rsclient) :  ?>  
	...
	onClick="showEdit(this);"><?php echo $rsclient['remarks'] ; ?></td>
	   <td> 
	 <button class="btnEditAction" name="tdsprocessed"
      onClick="callCrudAction('tdsprocessed','<?php echo $rsclient['id']; ?>','<?php echo $rsclient['ac_name']; ?>')">

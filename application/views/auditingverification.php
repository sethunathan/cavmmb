...
#btnAddAction{background-color:#09F;border:0;padding:5px 10px;color:#FFF;}
 ...
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>auditingfollowup/verification">
...
<form action="<?php echo base_url(); ?>auditingfollowup/verification" method="post">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> 
 ...
 <?php include 'movetobillaudit.php';?>
<script>
function callCrudAction(action,id,acname) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("auditingfollowup/movetotask2")?>',

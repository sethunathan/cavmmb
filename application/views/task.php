...
<head>
  ...
  <title>CAVMMB | Task Details</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url(); ?>admin/savetask/<?php echo $task_code;  ?>" method="post">
      <div class="form-group has-feedback">
        <input name="taskname"  value ="<?php echo $task_name?>" type="text" class="form-control" placeholder="Task Name">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
	 
	   
	  <div class="form-group has-feedback">
        <input name="starting_date"  value ="<?php echo $starting_date?>" type="text" class="form-control" placeholder="Staring Date">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
	  <div class="form-group has-feedback">
        <input name="ending_date"  value ="<?php echo $ending_date?>" type="text" class="form-control" placeholder="Ending Date">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>

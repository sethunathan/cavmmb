...
@page { margin: 0; }
  ...
  -webkit-text-fill-color: transparent;
			 ...
			 <?php foreach ($masaccounts as $rsmasaccounts)
			{
				...
				$tinno=$rsmasaccounts['gststate'].'-'.$rsmasaccounts['gststatename'] ;
			} 
			?> 
            ...
            <td  width="25%">			
					<table>
						...
						<tr>
							...
							<td contenteditable><?php echo $tinno; ?></td>
						</tr>
...
<script>
 $("#e2").select2({closeOnSelect:true}); 
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th width="32%" align="center"><span contenteditable>Item</span></th>
						<th width="12%"><span contenteditable>S.A.C.</span></th>
                        <th width="12%"><span>Tax Per</span></th>						 						
						<th width="12%">₹<span>Price</span></th>
						<th width="12%">₹<span>IGST</span></th>
	        ...
	        <tr>
						...
						<td><span ><?php echo $clientt['sac'] ; ?></span></td>	
                        <td><span><?php echo $taxper=$clientt['taxper'].'%' ; ?></span></td>						
						<td>₹<span><?php echo $clientt['rate'] ; ?> </span></td> 
						<td>₹<span><?php echo $clientt['taxamt'] ; ?> </span></td>
						<td>₹<span><?php echo $clientt['totalamount']; ?> </span></td>						
					</tr>
  ...
  <?php endforeach ; ?>
    ...
    echo ($Rupees ? 'Rupees: ' . $Rupees : '') . $paise . " Only";
                         ...
                         <th>₹<span ><?php echo $rsgst['sumsgst']+$rsgst['sumsgst']  ; ?></span></th>
                        <th>₹ <span ><?php echo $rsgst['sumtotalamount'] ; ?></span></th>
                        </p>		
			</tr>
<?php endforeach ; ?>
				</tbody>

    ...
    <table class="table">
		 ...
		 <tr>
		    ...
		    <td><label>Accounts From</label></td>
				...
				{	 $str=$data->ac_name.'-'.$data->clos_bal;			           
		...
		<tr>   <td><label>Previous Balance</label></td>
				    <td> 
				      <div id="details" ></div> 
					</td>
		</tr>		     
...
<div class="col-sm-10">  
      ...
      Edit Bill
            ...
            <td><a 
			    target="_blank" href="<?php echo base_url(); ?>accounts/receiptprint/<?php echo $row->vch_no.'/'.$row->comp_id.'/'.$row->ac_code;  ?>">
 ...
 function loaddetailss()
	{
	    ...
	    $.ajax({
		    url: '<?php echo site_url("accounts/getbilllist")?>',
		    type:'POST',
			async: false,

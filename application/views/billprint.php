...
<script>
 $("#e2").select2({closeOnSelect:true}); 
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th width="12%">₹<span>CGST</span></th>
						<th width="12%">₹<span>SGST</span></th>
	        ...
	        <tr>
						...
						<td>₹<span><?php echo $clientt['cgst'] ; ?> </span></td>
						<td>₹<span><?php echo $clientt['sgst'] ; ?> </span></td>
  ...
  <?php endforeach ; ?>
    ...
    echo ($Rupees ? 'Rupees: ' . $Rupees : '') . $paise . " Only";
                         ...
                         <th>₹<span ><?php echo $rsgst['sumsgst'] ; ?></span></th>
                         <th>₹<span ><?php echo $rsgst['sumsgst'] ; ?></span></th>

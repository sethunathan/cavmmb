...
#btnAddAction{background-color:#09F;border:0;padding:5px 10px;color:#FFF;}
 ...
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>tdsfollowup/verification">
...
<form action="<?php echo base_url(); ?>tdsfollowup/verification" method="post">
...
function callCrudAction(action,id,acname) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("tdsfollowup/movetotask2")?>',

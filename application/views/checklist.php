...
function callCrudAction(action,id) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("checklist/checklistall")?>',
	data:{ action:action,addchecklistname:addchecklistname,checklistname:checklistname,details:details,checklist_code:id},
	type: "POST",
...
<div id="frmAdd">
<div class="txt-heading">New CheckList</div>
...
<div class="txt-heading">Edit CheckList</div>
...
?>
<div class="message-box" id="message_<?php echo $rsclient['checklist_code'];?>">
<div>
<button class="btnEditAction" name="edit" onClick="showEditBox(this,<?php echo $rsclient['checklist_code']; ?>)">Edit</button>
<button class="btnDeleteAction" name="delete"
 onClick="callCrudAction('delete',<?php echo $rsclient['checklist_code']; ?>)">
 Delete</button>

 
</div>
<div class="message-content"><?php echo $rsclient['checklistname']; ?></div>
</div>
<?php
}
} ?>

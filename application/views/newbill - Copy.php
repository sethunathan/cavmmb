...
<?php foreach ($masaccounts as $rsmasaccounts)
	...
	<article>	 
			...
			<table class="inventory">
				<thead>
					<tr>
					    ...
					    <th><span contenteditable>Ac Name</span></th>
						<th><span contenteditable>Item</span></th>
						<th><span contenteditable>HSN/SAC</span></th>
						<th><span contenteditable>Quantity</span></th>
						<th><span contenteditable>Price/Unit</span></th>
	        ...
	        <tr>
						<td><a class="cut">-</a><span><?php echo $i; ?></span></td>
						<td><span contenteditable><?php echo $clientt['ac_name'] ; ?></span></td>
...
function updateInvoice() {
	...
	for (var a = document.querySelectorAll('table.inventory tbody tr'), i = 0; a[i]; ++i) {
		...
		taxamt=0;
		taxper = parseFloatHTML(cells[7]);
		if (taxper>0)
	 	    {  taxamt1=taxper/100 ;
		       taxamt = parseFloatHTML(cells[6]) * taxamt1;
	        }
	  
		
		 
		cells[8].innerHTML = taxamt;
		cells[9].innerHTML = taxamt;
		cells[10].innerHTML = taxamt+taxamt+price;
	///	if (price>0)
	//	{
	//		if (taxper>0)
	//	    {

...
<form action="<?php echo base_url(); ?>othersfollowup/task" method="post">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
	  ...
	  <button type="button" id="movetoverificationlevelmodal" data-dismiss="modal"  class="btn btn-primary" name="movetoentrylevelmodal"
		...
		">
        Move to Verification Level-Test
	  </button> 
	</div>
...
function saveverificationlevelmodal(action,id,remarks) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("othersfollowup/movetoverificationlevelmodal")?>',
...
function callCrudAction(action,id,acname) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("othersfollowup/movetotask1")?>',

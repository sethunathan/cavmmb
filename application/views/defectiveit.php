...
#btnAddAction{background-color:#09F;border:0;padding:5px 10px;color:#FFF;}
 ...
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>admin/defectiveit">
            <i class="fa fa-dashboard"></i> <span>Defectiveit  I.T.R - Refresh</span>
...
<form action="<?php echo base_url(); ?>admin/defectiveit" method="post">
...
<?php $i=1; foreach ($client as $rsclient) :  ?>  
	...
	onBlur="saveDate(this,'remarks4','<?php  echo $rsclient['id'] ?>','<?php  echo $rsclient['ac_name'] ?>')"

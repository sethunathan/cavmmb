<?php include 'body.php';?>
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>ittask/newtask">
...
<td>
	...
	<a href="<?php echo base_url(); ?>ittask/edittask/<?php echo $data->task_code;  ?>"><button class="btn btn-primary" type="button">Edit</button></a>	
  </td>
  </tr>

...
#btnAddAction{background-color:#09F;border:0;padding:5px 10px;color:#FFF;}
 ...
 <li class="active treeview">
          <a href="<?php echo base_url(); ?>Tdsfollowup/futurelist">
...
<form action="<?php echo base_url(); ?>Tdsfollowup/futurelist" method="post">
...
<table class="table">
  <tr class="AdminTableHeader">
    ...
    <td>Assign To</td>   	
	<td>Remarks(*)</td>			 
	<td>Reverse to Followup List</td>
...
<?php $i=1; foreach ($client as $rsclient) :  ?>  
    ...
    <td> 
	 <button class="btnEditAction" name="followp"
      onClick="callCrudAction('followp','<?php echo $rsclient['id']; ?>','<?php echo $rsclient['ac_name']; ?>')">
      Reverse to Followup List</button> 
      </td>

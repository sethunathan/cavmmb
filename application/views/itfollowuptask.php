...
<a target="_blank" href="https://incometaxindiaefiling.gov.in/home" class="btn btn-block btn-success"><span class="glyphicon glyphicon-off"></span> IT LOGIN</a>
<style>
...
<form action="<?php echo base_url(); ?>itfollowup/task" method="post">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
	   ...
	   <?php //Verification 4.MOVE TO Verification LEVEL  ?>
...
function saveverificationlevelmodal(action,id,remarks) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("itfollowup/movetoverificationlevelmodal")?>',
...
function callCrudAction(action,id,acname) {
	...
	jQuery.ajax({
	url: '<?php echo site_url("itfollowup/movetotask1")?>',

	...
	<div class="services_overview">
        <div class="container">
       		...
       		<div class="col-md-4 service_grid">
       			<img src="<?php echo base_url(); ?>images/p2.jpg" class="img-responsive" alt=""/>
       			<h4>On the other hand, we denounce</h4>
       			<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate</p>
       		  
       		</div>
       		<div class="col-md-4 service_grid">
       			<img src="<?php echo base_url(); ?>images/p1.jpg" class="img-responsive" alt=""/>
       			<h4>On the other hand, we denounce</h4>
       			<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate</p>
       		    
       		</div>
       		<div class="col-md-4 service_grid span_55">
       			<img src="<?php echo base_url(); ?>images/p3.jpg" class="img-responsive" alt=""/>
       			<h4>On the other hand, we denounce</h4>
       			<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate</p>
		...
		<div class="container">
			...
			<!---strat-image-cursuals---->
                  <div class="scroll-slider">											 
							...
							<li><img src="<?php echo base_url(); ?>images/c1.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c2.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c3.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c4.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c1.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c2.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c3.jpg"></li>
							<li><img src="<?php echo base_url(); ?>images/c4.jpg"></li>

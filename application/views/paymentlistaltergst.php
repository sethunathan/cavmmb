...
<a target="_blank" href="https://services.gst.gov.in/services/login" class="btn btn-block btn-success">
<span class="glyphicon glyphicon-off"></span> GST LOGIN</a>
 <style>
...
<form  id="test" action="<?php echo base_url(); ?>Followup/paymentlistgst" method="post">
<div class="form-group has-feedback table-responsive">   
 ...
 // document.getElementById('followupp').value = "<?php echo $_GET['followupp'];?>";
    ...
    <input type="checkbox" name="loadbill" value="1"> Show Already Billed Also<br>
